...
export default function Footer() {
  return (
    <footer
      className="ab-footer text-center"
      style={{ backgroundColor: "#f1f1f1" }}
    >
      <div className="container pt-9">
        <div className="flex justify-center mb-9">
          <a href="#!" className="mr-9 cr-wh">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
      ...
      <div
        className="text-center cr-wh p-4"
        style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}
      >
        © 2023 Copyright:
        <a className="cr-wh" href="https://tailwind-elements.com/">
          Amine Chairi
        </a>
      </div>
    </footer>
